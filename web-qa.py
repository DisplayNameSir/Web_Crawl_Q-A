...
if SJSU:
    domain = "www.tomshardware.com" # "www.sjsu.edu"
    full_url = "https://www.tomshardware.com/how-to/build-a-pc"
...
if SJSU:
    ...
    print(answer_question(df, question="What is this website about?", debug=False))
    time.sleep(3)

    print("\nWho owns this website?\n")
    print(answer_question(df, question="Who owns this website?"))
    time.sleep(3)
